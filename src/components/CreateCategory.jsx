...
const CreateCategory = () => {
    ...
    // Abrir el modal de edición con los datos de la categoria seleccionada
    ...
    // Función para manejar la creación de la categoria
    const createCollection = async () => {
        if (!collectionName) {
            setSnackbarMessage('Por favor, ingrese el nombre de la categoria');
        ...
        try {
            ...
            setSnackbarMessage(`La categoria "${collectionName}" ha sido creada exitosamente`);
            setSnackbarSeverity('success');
            setOpenSnackbar(true);
            setCollectionName(''); // Limpiar el campo de texto
            fetchCollections(); // Actualizar la tabla
        } catch (error) {
            setSnackbarMessage('Hubo un problema al crear la categoria. Inténtalo de nuevo.');
            setSnackbarSeverity('error');
            setOpenSnackbar(true);
            console.error(error);
        }
    ...
    const editCollection = async () => {
        if (!collectionName || !selectedCollection) {
            setSnackbarMessage('Por favor, ingrese un nombre válido para la categoria');
            setSnackbarSeverity('error');
            setOpenSnackbar(true);
            return;
        }
        ...
        try {
            ...
            setSnackbarMessage(`La categoria "${collectionName}" ha sido actualizada exitosamente`);
            setSnackbarSeverity('success');
            setOpenSnackbar(true);
            setCollectionName(''); // Limpiar el campo de texto
            fetchCollections(); // Actualizar la tabla
            ...
            setSnackbarMessage('Hubo un problema al actualizar la categoria.');
            setSnackbarSeverity('error');
            setOpenSnackbar(true);
            console.error(error);
        }
    ...
    const deleteCollection = async (id) => {
        try {
            ...
            setSnackbarMessage('Hubo un problema al eliminar la categoria.');
            setSnackbarSeverity('error');
            setOpenSnackbar(true);
        }
    };
